...
@UnitTest
class OpdocaiCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class OpdocaiCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = OpdocaiCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = OpdocaiCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class OpdocaiCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = OpdocaiCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = OpdocaiCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class OpdocaiCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = OpdocaiCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = OpdocaiCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class OpdocaiMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = OpdocaiCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = OpdocaiCollections.immutable(input);
